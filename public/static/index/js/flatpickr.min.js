...
function Flatpickr(e, t) {
    function n() {
        K.element = e,
        K.instanceConfig = t || {},
        K.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),
        j(),
        M(),
        S(),
        F(),
        ...
        K.setDate = T,
        K.toggle = H,
        K.isMobile && !K.config.disableMobile ? (r(), N()) : (o(), r()),
        K.selectedDateObj && P(),
        _("Ready")
    }
    function a(e) {
    ...
    function r() {
        ...
        K.isMobile || (document.addEventListener("keydown", y), window.addEventListener("resize", U(w, 300)), document.addEventListener("click", h), document.addEventListener("blur", h), K.config.clickOpens && (K.altInput || K.input).addEventListener("focus", D), K.config.noCalendar || (K.prevMonthNav.addEventListener("click",
        function() {
            return p( - 1)
        }), K.nextMonthNav.addEventListener("click",
        function() {
            return p(1)
        }), K.currentYearElement.addEventListener("wheel", W), K.currentYearElement.addEventListener("focus",
        function() {
        ...
        function(e) {
            ...
            K.redraw()
        }), K.days.addEventListener("click", L)), K.config.enableTime && (K.timeContainer.addEventListener("wheel", a), K.timeContainer.addEventListener("wheel", U(function() {
            return _("Change")
        },
    ...
    function o() {
        ...
        K.calendarContainer = B("div", "flatpickr-calendar"),
        K.config.noCalendar || (e.appendChild(c()), K.config.weekNumbers && e.appendChild(d()), K.rContainer = B("div", "flatpickr-rContainer"), K.rContainer.appendChild(s()), K.rContainer.appendChild(l()), e.appendChild(K.rContainer)),
    ...
    function c() {
        var e = document.createDocumentFragment();
        return K.monthNav = B("div", "flatpickr-month"),
        K.prevMonthNav = B("span", "flatpickr-prev-month"),
        K.prevMonthNav.innerHTML = K.config.prevArrow,
        K.currentMonthElement = B("span", "cur_month"),
        K.currentYearElement = B("input", "cur_year"),
        K.currentYearElement.type = "number",
        K.currentYearElement.title = Flatpickr.l10n.scrollTitle,
        K.nextMonthNav = B("span", "flatpickr-next-month"),
        K.nextMonthNav.innerHTML = K.config.nextArrow,
        K.navigationCurrentMonth = B("span", "flatpickr-current-month"),
    ...
    function u() {
        ...
        K.timeContainer = B("div", "flatpickr-time"),
        K.timeContainer.tabIndex = -1;
        var e = B("span", "flatpickr-time-separator", ":");
        return K.hourElement = B("input", "flatpickr-hour"),
        K.minuteElement = B("input", "flatpickr-minute"),
        K.hourElement.tabIndex = K.minuteElement.tabIndex = 0,
        K.hourElement.type = K.minuteElement.type = "number",
        K.hourElement.value = K.selectedDateObj ? C(K.selectedDateObj.getHours()) : 12,
        K.minuteElement.value = K.selectedDateObj ? C(K.selectedDateObj.getMinutes()) : "00",
        ...
        K.config.enableSeconds && (K.timeContainer.classList.add("has-seconds"), K.secondElement = B("input", "flatpickr-second"), K.secondElement.type = "number", K.secondElement.value = K.selectedDateObj ? C(K.selectedDateObj.getSeconds()) : "00", K.secondElement.step = K.minuteElement.step, K.secondElement.min = K.minuteElement.min, K.secondElement.max = K.minuteElement.max, K.timeContainer.appendChild(B("span", "flatpickr-time-separator", ":")), K.timeContainer.appendChild(K.secondElement)),
        K.config.time_24hr || (K.amPM = B("span", "flatpickr-am-pm", ["AM", "PM"][K.hourElement.value > 11 | 0]), K.amPM.title = Flatpickr.l10n.toggleTitle, K.amPM.tabIndex = 0, K.timeContainer.appendChild(K.amPM)),
        K.timeContainer
    }
    function s() {
        ...
        K.weekdayContainer.innerHTML = "<span class=flatpickr-weekday>" + t.join("</span><span class=flatpickr-weekday>") + "</span>",
        K.weekdayContainer
    }
    function d() {
        return K.calendarContainer.classList.add("hasWeeks"),
        K.weekWrapper = B("div", "flatpickr-weekwrapper"),
        K.weekWrapper.appendChild(B("span", "flatpickr-weekday", Flatpickr.l10n.weekAbbreviation)),
        K.weekNumbers = B("div", "flatpickr-weeks"),
    ...
    function h(e) {
        ...
        n = K.element.contains(e.target) || e.target === K.altInput; ! K.isOpen || t || n || K.close()
    }
    function v(e, t) {
        var n = e.split("");
    ...
    function b() { (K.currentMonth < 0 || K.currentMonth > 11) && (K.currentYear += K.currentMonth % 11, K.currentMonth = (K.currentMonth + 12) % 12)
    }
    function k(e) {
    ...
    function w() { ! K.isOpen || K.config.inline || K.config["static"] || I()
    }
    function D(e) {
    ...
    function L(e) {
        if (e.preventDefault(), e.stopPropagation(), !K.config.allowInput || e.target !== K.altInput && e.target !== K.input || 13 !== e.which) {
            if (e.target.classList.contains("flatpickr-day") && !e.target.classList.contains("disabled")) {
                ...
                n = e.target.classList.contains("nextMonthDay"); (t || n) && p( + n - t),
                K.selectedDateObj = E(new Date(K.currentYear, K.currentMonth, e.target.innerHTML)),
                P(e),
                l(),
                _("Change"),
    ...
    function S() {
        ...
        K.config.altInput && (K.altInput = B(K.input.nodeName, "flatpickr-input " + K.config.altInputClass), K.altInput.placeholder = K.input.placeholder, K.altInput.type = "text", K.input.type = "hidden", K.input.parentNode.insertBefore(K.altInput, K.input.nextSibling)),
    ...
    function N() {
        ...
        if (K.mobileInput = B("input", "flatpickr-input"), K.mobileInput.step = "any", K.mobileInput.tabIndex = -1, K.mobileInput.type = e, K.selectedDateObj) {
    ...
    function P() {
        ...
        if (K.config.enableTime && !K.isMobile) {
            ...
            K.hourElement.value = C(K.config.time_24hr ? t: (12 + t) % 12 + 12 * (t % 12 === 0)),
            K.minuteElement.value = C(n),
            void 0 !== K.secondElement && (K.secondElement.value = C(a))
        }
...
Flatpickr.l10n = {
    weekdays: {
        ...
        longhand: ["星期天", "星期一", "星期二", "星期三", "星期四", "星期五", "星期六"]
    },
    months: {
